...
#         enhance_image_1 = self.encoder(enhance_image_1)
#         enhance_image_1 = self.decoder(enhance_image_1)
...
#         output = self.decoder(x_encode)
#         return enhance_image_1, output, r
